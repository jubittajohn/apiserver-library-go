...
replace (
	...
	k8s.io/controller-manager => k8s.io/controller-manager v0.36.0-rc.1
	k8s.io/kube-scheduler => k8s.io/kube-scheduler v0.36.0-rc.1
)
...
require (
	...
	k8s.io/apiextensions-apiserver v0.36.0-rc.1 // indirect
	k8s.io/component-base v0.36.0-rc.1 // indirect
	k8s.io/component-helpers v0.36.0-rc.1 // indirect
	k8s.io/controller-manager v0.32.1 // indirect
	k8s.io/dynamic-resource-allocation v0.36.0-rc.1 // indirect
